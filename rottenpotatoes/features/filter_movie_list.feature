...
Scenario: restrict to movies with 'PG' or 'R' ratings
  ...
  And I should not the see the following movies: Aladdin, The Help, Chocolat, 2001: A Space Odyssey, Chicken Run
  

Scenario: all ratings selected
  # see assignment
  
  When I check the following ratings: G, PG, PG-13, RottenPotatoes
